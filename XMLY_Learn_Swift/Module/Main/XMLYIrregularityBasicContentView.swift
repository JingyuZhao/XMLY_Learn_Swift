//
//  XMLYIrregularityBasicContentView.swift
//  XMLY_Learn_Swift
//
...
class XMLYIrregularityBasicContentView: XMLYBouncesContentView {
...
class XMLYIrregularityContentView: ESTabBarItemContentView {
