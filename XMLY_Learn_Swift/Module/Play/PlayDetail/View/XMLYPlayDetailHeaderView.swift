//
//  XMLYPlayDetailHeaderView.swift
//  XMLY_Learn_Swift
//
...
class XMLYPlayDetailHeaderView: UIView {
    ...
    private lazy var subscibeBtn:UIButton = {
        let button = UIButton()
        button.backgroundColor = XMLYButtonColor
    ...
    func setUI() {
        self.blurImageView = UIImageView.init(frame:  CGRect(x:0 , y:0 , width: XMLYScreenWidth, height: self.frame.height - 80))
