...
struct XMLYPlayDetailModel : HandyJSON {
    var album:XMLYPlayDetailAlbumModel?
    var user:XMLYPlayDetailUserModel?
    var tracks:XMLYPlayDetailTracksModel?
...
struct XMLYPlayDetailAlbumModel:HandyJSON {
    var albumId:Int = 0
...
struct XMLYPlayDetailUserModel:HandyJSON {
    var uid:Int = 0
    var nickname:String?
    var isVerified:Bool = false
...
struct XMLYPlayDetailTracksModel:HandyJSON {
    var list:[XMLYPlayDetailTracksListModel]?
}

struct XMLYPlayDetailTracksListModel:HandyJSON {
    var trackId:Int = 0
    var uid:Int = 0
    var duration:Int = 0
    var albumId:Int = 0
