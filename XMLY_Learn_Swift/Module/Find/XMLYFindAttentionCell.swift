...
class XMLYFindAttentionCell: UITableViewCell {

    private var eventInfos:XMLYEventInfosModel?
    ...
    // 评论
    lazy var commnetLabel : XMLYCustomLabel = {
    ...
    lazy var collectionView : UICollectionView = {
        ...
        collectionView.register(XMLYFindImageCell.self, forCellWithReuseIdentifier:"XMLYFindAttentionPicCell")
    ...
    func setUpLayout(){
        ...
        self.collectionView.snp.makeConstraints { (make) in
            ...
            make.height.equalTo((XMLYScreenWidth - 30) / 3 + 20)
        }
    }
    ...
    var eventInfosModel:XMLYEventInfosModel? {
        didSet {
    ...
    func height(for commentModel: XMLYFindAContentInfo?) -> CGFloat {
        ...
        height += label.sizeThatFits(CGSize(width: XMLYScreenWidth - 30, height: CGFloat.infinity)).height
        return height
    }
...
extension XMLYFindAttentionCell : UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout{
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.eventInfos?.contentInfo?.picInfos?.count ?? 0
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell:XMLYFindImageCell = collectionView.dequeueReusableCell(withReuseIdentifier: "XMLYFindAttentionPicCell", for: indexPath) as! XMLYFindImageCell
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        return CGSize.init(width: (XMLYScreenWidth - 30) / 3, height:(XMLYScreenWidth - 30) / 3)
    }
