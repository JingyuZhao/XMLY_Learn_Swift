//
//  XMLYClassifySubVerticalCell.swift
//  XMLY_Learn_Swift
//
...
class XMLYClassifySubVerticalCell: UICollectionViewCell {
    // 图片
    ...
    private var paidLabel: UILabel = {
        ...
        label.backgroundColor = UIColor.init(red: 248.0/255.0, green: 210.0/255.0, blue: 74.0/255.0, alpha: 1);
