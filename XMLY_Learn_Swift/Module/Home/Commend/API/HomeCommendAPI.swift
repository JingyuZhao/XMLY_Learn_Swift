...
let XMLYHomeCommendProvider = MoyaProvider<XMLYHomeCommendAPIType>()
//HomeCommendAPIType要实现TargetType协议
extension XMLYHomeCommendAPIType : TargetType{
    var baseURL: URL {
        switch self {
        case .recommendList:
