//
//  XMLYHomeCommendHeaderCell.swift
//  XMLY_Learn_Swift
//
...
/// 添加按钮点击代理方法
protocol XMLYRecommendHeaderCellDelegate:NSObjectProtocol {
    func recommendHeaderBtnClick(categoryId:String,title:String,url:String)
    func recommendHeaderBannerClick(url:String)
}
class XMLYHomeCommendHeaderCell: UICollectionViewCell {
    private var focus:XMLYFocusModel?
    private var square:[XMLYSquareModel]?
    private var topBuzzList:[XMLYTopBuzzModel]?
    
    weak var delegate : XMLYRecommendHeaderCellDelegate?
    ...
    // MARK: - 懒加载九宫格分类按钮
       private lazy var gridView: UICollectionView = {
           ...
           collectionView.register(XMLYRecommendGridCell.self, forCellWithReuseIdentifier: "XMLYRecommendGridCell")
           collectionView.register(XMLYRecommendNewsCell.self, forCellWithReuseIdentifier: "XMLYRecommendNewsCell")
    ...
    var topBuzzListData:[XMLYTopBuzzModel]? {
        didSet{
...
extension XMLYHomeCommendHeaderCell:FSPagerViewDelegate,FSPagerViewDataSource{
...
extension XMLYHomeCommendHeaderCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if  indexPath.section == 0 {
            let cell:XMLYRecommendGridCell = collectionView.dequeueReusableCell(withReuseIdentifier: "XMLYRecommendGridCell", for: indexPath) as! XMLYRecommendGridCell
            cell.square = self.square?[indexPath.row]
            return cell
        }else {
            let cell:XMLYRecommendNewsCell = collectionView.dequeueReusableCell(withReuseIdentifier: "XMLYRecommendNewsCell", for: indexPath) as! XMLYRecommendNewsCell
...
//        if indexPath.section == 0 {
//            return CGSize.init(width: (XMLYScreenWidth - 5)/5, height:80)
//        }else {
            return CGSize.init(width: XMLYScreenWidth, height: 50)
//        }
    }
