...
class XMLYRecommendNewsCell: UICollectionViewCell {
    private var topBuzz:[XMLYTopBuzzModel]?
       ...
       private lazy var collectionView: UICollectionView = {
           ...
           layout.itemSize = CGSize(width: (XMLYScreenWidth - 150), height:40)
           let collectionView = UICollectionView.init(frame:CGRect(x:80,y:5, width:XMLYScreenWidth-150, height:40), collectionViewLayout: layout)
           layout.scrollDirection = UICollectionView.ScrollDirection.vertical
           collectionView.contentSize = CGSize(width: (XMLYScreenWidth - 150), height: 40)
           ...
           collectionView.register(XMLYNewsCell.self, forCellWithReuseIdentifier:"LBFMNewsCell")
...
extension XMLYRecommendNewsCell : UICollectionViewDelegate, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return (self.topBuzz?.count ?? 0)*100
    }

    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell:XMLYNewsCell = collectionView.dequeueReusableCell(withReuseIdentifier: "LBFMNewsCell", for: indexPath) as! XMLYNewsCell
...
class XMLYNewsCell: UICollectionViewCell {
